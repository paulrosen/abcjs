...
var ParserLint = function () {
  ...
  var percMapElement = {
    ...
    properties: {
      ...
      noteHead: {
        type: "string",
        Enum: ["normal", "harmonic", "rhythm", "x", "triangle"],
        optional: true
      }
    }
  };
  ...
  var chordProperties = {
    ...
    properties: {
      ...
      position: {
        type: "string",
        Enum: ["above", "below", "left", "right", "default"],
        optional: true,
        prohibits: ["rel_position"]
      },
      rel_position: {
        type: "object",
  ...
  var noteProperties = {
    ...
    rest: {
      ...
      properties: {
        ...
        }, // multimeasure requires duration to be the number of measures.
    ...
    tripletR: { type: "number", minimum: 0.1, maximum: 9, optional: true },
  ...
  var keyProperties = {
    // change deepCopyKey (in parse_header) if there are changes around here
    accidentals: {
      type: "array",
      optional: true,
      output: "noindex",
    ...
    root: {
      type: "string",
      Enum: ["A", "B", "C", "D", "E", "F", "G", "HP", "Hp", "none"]
    },
    acc: { type: "string", Enum: ["", "#", "b"] },
    mode: {
      type: "string",
      Enum: ["", "m", "Dor", "Mix", "Loc", "Phr", "Lyd"]
    }
  };
  ...
  var meterProperties = {
    ...
    value: {
      type: "array",
      optional: true,
      output: "noindex", // TODO-PER: Check for type=specified and require these in that case.
      items: {
        type: "object",
        properties: {
          num: { type: "string" },
    ...
    beat_division: {
      type: "array",
      optional: true,
      output: "noindex", // This is displayed inside parens, but is just an elaboration of the "value" field, not more info.
      items: {
        type: "object",
        properties: {
          num: { type: "string" },
    ...
    types: [
      ...
      { value: "midi", properties: appendPositioning(midiProperties) },
      {
        ...
        properties: {
          type: "array",
          items: {
            // This goes back to the last measure to start the notes in this note array.
      ...
      {
        value: "part",
        properties: prependPositioning({ title: { type: "string" } })
      },
      {
        value: "scale",
        properties: {
          size: { type: "number", optional: true, minimum: 0.5, maximum: 2 }
        }
      },
      {
        value: "stem",
  ...
  var lineProperties = {
    type: "array",
    description:
      "This is an array of horizontal elements. It is usually a staff of music. For multi-stave music, each staff is an element, just like single-staff. The difference is the connector properties.",
    items: {
      type: "object",
      properties: {
        columns: {
          type: "array",
          optional: true, // The width of the columns is fixed and even for all columns. That is known by the number of columns in the array.
          items: {
            type: "object",
            properties: {
        ...
        subtitle: {
          type: "object",
          optional: true,
          prohibits: ["staff", "text", "separator"],
          properties: {
            endChar: { type: "number" },
            startChar: { type: "number" },
            text: { type: "string" }
        ...
        text: {
          type: "object",
          optional: true,
          prohibits: ["staff", "subtitle", "separator"],
          properties: {
            endChar: { type: "number" },
            startChar: { type: "number" },
    ...
    properties: {
      ...
      metaText: {
        ...
        properties: {
          ...
          footer: {
            type: "object",
            optional: true, // The strings %P, %P0, and %P1 should be replaced with the page number
            properties: {
              left: { type: "string" },
              center: { type: "string" },
              right: { type: "string" }
