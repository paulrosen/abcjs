...
function drawRelativeElement(renderer: any, params: any, bartop: any) {
  ...
  switch (params.type) {
    ...
    case "part":
      ...
      break;
    case "bar":
      params.graphelem = printStem(
        renderer,
        params.x,
        params.linewidth,
        y,
        bartop ? bartop : renderer.calcY(params.pitch2),
        null,
        "bar"
      );
