...
var Classes = require('./helpers/classes').Classes;
var GetFontAndAttr = require('./helpers/get-font-and-attr').GetFontAndAttr;
var GetTextSize = require('./helpers/get-text-size').GetTextSize;
