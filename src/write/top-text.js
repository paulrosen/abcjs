...
//		TopText.prototype.addTextIf = function (marginLeft, text, font, klass, marginTop, marginBottom, anchor, getTextSize, absElemType, noMove) {
	...
	if (lines[0] && lines[0].subtitle) {
		addTextIf(this.rows, { marginLeft: tLeft, text: lines[0].subtitle, font: 'subtitlefont', klass: 'text meta-top subtitle', marginTop: spacing.subtitle, anchor: tAnchor, absElemType: "subtitle" , info: metaTextInfo.subtitle, name: "subtitle"}, getTextSize);
	}
