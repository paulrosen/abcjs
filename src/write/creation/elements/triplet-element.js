...
var TripletElem = function TripletElem(number, anchor1, options) {
	...
	this.anchor1 = undefined; // Set later if the tuplet starts with an invisible rest.
	if (anchor1)
		this.setStartAnchor(anchor1);
};

TripletElem.prototype.setStartAnchor = function (anchor1) {
	this.anchor1 = anchor1; // must have a .x and a .parent property
