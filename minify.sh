...
java -jar yuicompressor-2.4.2.jar  --line-break 7000 -o abcjs_editor-min.js abcjs_editor.js
java -jar yuicompressor-2.4.2.jar  --line-break 7000 -o abcjs_plugin-nojquery-min.js abcjs_plugin.js
cat jquery-1.4.2.min.js abcjs_plugin-nojquery-min.js > abcjs_plugin-min.js
