...
NEAR TERM PLAN:
I hope to have the next beta around mid to late July. It will be mostly audio improvements, but there will likely be bugs fixes everywhere. 
...
BETA NOTE:
The documentation has only been partly updated for the beta version.
